...
/**
 * Contains unit tests for mod_sumtrain\dates.
 *
...
/**
 * Class for unit testing mod_sumtrain\dates.
 *
 * @copyright Shamim Rezaie <shamim@moodle.com>
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class dates_test extends advanced_testcase {
     ...
     * @param int|null $timeopen Time of opening the sumtrain
     * @param int|null $timeclose Time of closing the sumtrain
    ...
    public function test_get_dates_for_module(?int $timeopen, ?int $timeclose, array $expected): void {
        ...
        $sumtrain = $this->getDataGenerator()->create_module('sumtrain', $data);
