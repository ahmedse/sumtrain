@mod @mod_sumtrain
Feature: A teacher can choose whether to publish sumtrain activity results anonymously or showing names
  ...
  Scenario: Publish anonymous results
    Given the following "activities" exist:
      ...
      | sumtrain   | sumtrain 1 | sumtrain Description | C1     | sumtrain1  | Option 1, Option 2 | 1       |
