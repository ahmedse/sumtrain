@mod @mod_sumtrain
Feature: sumtrain with no calendar capabilites
  In order to allow work effectively
  As a teacher
  I need to be able to create sumtrains even when I cannot edit calendar events
  ...
  Scenario: Editing a sumtrain
    ...
    And I press "Save and return to course"
    Then I should see "Test sumtrain name"
