@mod @mod_sumtrain
Feature: Update a sumtrain activity removing options
  In order to remove incorrect or unwanted options
  As a teacher
  I need to update the sumtrain activity

  Scenario: Update a sumtrain activity that has student responses.
    ...
    And the following "activities" exist:
      ...
      | sumtrain   | sumtrain name | sumtrain Description | C1     | sumtrain1  | Option 1, Option 2, Option 3 | 1       |
