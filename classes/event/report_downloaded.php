 ...
 *      - int sumtraind: The id of the sumtrain
 * }
 *
 * @package    mod_sumtrain
 * @since      Moodle 3.1
...
class report_downloaded extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventreportdownloaded', 'mod_sumtrain');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' has downloaded the report in the '".$this->other['format']."' format for
            the sumtrain activity with course module id '$this->contextinstanceid'";
    }
