...
/**
 * The mod_sumtrain answer created event.
 *
...
/**
 * The mod_sumtrain answer created event class.
 *
...
class answer_created extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventanswercreated', 'mod_sumtrain');
    }
    ...
    public static function get_objectid_mapping() {
        return array('db' => 'sumtrain_answers', 'restore' => 'answer');
    }
