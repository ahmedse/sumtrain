...
/**
 * Contains the class for fetching the important dates in mod_sumtrain for a given module instance and a user.
 *
...
/**
 * Class for fetching the important dates in mod_sumtrain for a given module instance and a user.
 *
 * @copyright Shamim Rezaie <shamim@moodle.com>
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class dates extends activity_dates {
    ...
    /**
     * Returns a list of important dates in mod_sumtrain
     *
     * @return array
     */
